	...
	<div class="container">
		<div class="row">
					...
					<tbody>
						...
						<tr class="active">
							<td width="60" width="40%"><input type="hidden" name="id"
								value="22"> <img
								src="<%=request.getContextPath() + "/" + orderItem.getProduct().getPimage()%>"
								width="70" height="60"></td>
							<td width="30%"><a target="_blank"> <%=orderItem.getProduct().getPname() %></a></td>
							<td width="20%">￥<%=orderItem.getProduct().getShop_price() %></td>
							<td width="10%"><%=orderItem.getCount() %></td>
							<td width="15%"><span class="subtotal">￥<%=orderItem.getSubtotal() %></span></td>
						</tr>
						<%
							}
						%>
			...
			<div style="text-align: right; margin-right: 120px;">
				商品金额: <strong style="color: #ff6600;">￥<%=order.getTotal() %>元</strong>
			</div>
