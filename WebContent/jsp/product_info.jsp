		...
		<div class="row">
			<div
				...
				<a href="<%=request.getContextPath()%>">首页&nbsp;&nbsp;</a>&gt; <a
					href="<%=request.getContextPath()%>/product?method=findByPage&cid=<%=product.getCategory().getCid()%>&currPage=1"><%=product.getCategory().getCname()%></a>
			</div>
			...
			<div style="margin: 0 auto; width: 950px;">
				<div class="col-md-6">
					<img style="opacity: 1; width: 400px; height: 350px;" title=""
						class="medium"
						src="<%=request.getContextPath() + "/" + product.getPimage()%>">
				</div>

				<div class="col-md-6">
					<form id="form"
						action="<%=request.getContextPath()%>/cart?method=add2Cart"
						method="post">
						...
						<div
							...
							<div>
								编号：<%=product.getPid()%></div>
						</div>

						<div style="margin: 10px 0 10px 0;">
							商城价: <strong style="color: #ef0101;">￥：<%=product.getShop_price()%>元/份
							</strong> 参 考 价：
							<del>
								￥<%=product.getMarket_price()%>元/份
							</del>
						</div>
