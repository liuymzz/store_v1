		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form class="form-horizontal" style="margin-top: 5px;" method="post"
					action="${pageContext.request.contextPath}/user?method=registerService">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" name="picCode">

						</div>
						<div class="col-sm-2">
							<img src="${pageContext.request.contextPath}/user?method=picCode"
